...
There are often many useful implementations for a given ADT. The decision of which implementation to usedepends on 
...
(front) of the list along with a `size` variable indicating how many items are in the list.
